...
```
cmake ../ -DBUILD_PYTHON=ON -DPYTHON_EXECUTABLE=/usr/bin/python3.8 -DPYTHON_LIBRARY=/usr/lib/x86_64-linux-gnu/libpython3.8.so -DUSE_CUDNN=OFF -DDOWNLOAD_BODY_25_MODEL=ON
```
```
make -j`nproc`
```
